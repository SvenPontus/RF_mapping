...
def convert_video(input_path, crop_x=1274, crop_y=720, target_fps=30):
    ...
    # Calculate top-left corner of the crop to center it
    ...
    while cap.isOpened():
        ...
        if frame_count % frame_skip_ratio < 1:
            # Crop the frame from the center
...
# Example usage:
input_video = '/local/data2/LIA_LIU_PONTUS/LIA_LIU/untrained_videos/GH010137.MP4'
